...
const pervostPlan: MarketingPlan = {
  ...
  customerProblems: {
    title: '6 مشاكل حقيقية يعانيها المشترون على أمازون وفي الواقع',
    problems: [
      {
        icon: 'FileWarning',
        title: 'وصلات مقلدة وبيانات مضللة على أمازون',
        description: 'يشتري الزبون وصلة سريعة (Quick Coupling) معتقداً أنها أصلية، فيجد منتجاً مقلداً لا يطابق المقاسات الحقيقية. البائعون يخفون الـ Profile النوع (NW7.4 أو NW12.5) في وصف غامض، مما يجعل الوصلة غير متوافقة مع الأدوات الموجودة ومضيعة للمال. حل Prevost: وصلات موثقة بالكود الفني الكامل وشهادة CE لكل قطعة.'
      },
      {
        icon: 'Skull',
        title: 'خطر جلد الخرطوم عند فصل الهواء فجأة (Hose Whip)',
        description: 'الوصلات التقليدية الرخيصة تفصل الهواء فجأة دون تخفيف الضغط أولاً، فينقلب الخرطوم بقوة انفجارية كافية لكسر العظام أو إصابة العيون. في المصانع الأوروبية، هذا مصنف ضمن أعلى أسباب الإصابة. حل Prevost: وصلة PrevoS1 بنظام تخفيف ضغط ثنائي المرحلة + خاصية Anti-Hose-Whip مدمجة — الاستثمار الأمثل للسلامة.'
      },
      {
        icon: 'AlertTriangle',
        title: 'هدر طاقة ضخم بسبب تسريبات الهواء (Energy Waste)',
        description: 'في المصانع والورش، 20% إلى 40% من الهواء المضغوط يضيع عبر تسريبات صغيرة في الوصلات والأنابيب الرديئة. كل ثقب بقطر 1mm عند 7 bar يكلف ما يعادل 100-200 يورو سنوياً في الكهرباء. الورشة المتوسطة تخسر الآلاف سنوياً دون أن تدرك السبب. حل Prevost: أنابيب PPS الألومنيوم بإحكام تام + وصلات PrevoS1 صفرية التسريب.'
      },
      {
        icon: 'Ban',
        title: 'عدم توافق الأبعاد والبروفايلات بين المنتجات المختلفة',
        description: 'سوق أمازون يبيع وصلات بأبعاد مختلطة (NW7.2، NW7.4، NW12.5، Industrial، Milton) دون توضيح كافٍ. المشتري يستلم المنتج ليجد أنه غير متوافق مع ما يمتلكه. النتيجة: خسارة مزدوجة من الوقت والمال. حل Prevost: تصنيف واضح لكل البروفايلات + نظام موحد يضمن التوافق الكامل بين كل قطع المجموعة.'
      },
      {
        icon: 'ShieldOff',
        title: 'غياب الشهادات والمعايير الأمنية المعتمدة',
        description: 'ضواغط وصلات مباعة على أمازون لا تحمل أي شهادة CE، ISO 4414، ولا EN 983. المنتج قد يتحمل الضغط يوماً أو شهراً، ثم يتشقق بدون إنذار تحت الضغط الحراري في بيئة الخليج. حل Prevost: 100% من المنتجات معتمدة CE + ISO + PED (Pressure Equipment Directive) — 45 سنة من التطابق مع أعلى المعايير.'
      },
      {
        icon: 'HeartCrack',
        title: 'لا دعم فني — المشتري وحده أمام الغموض',
        description: 'المشتري على أمازون يحتاج لمعرفة: ما القطر المناسب لشبكته؟ كم عدد الوصلات؟ أين تضع الفلاتر؟ لا أحد على أمازون يجيبه. يبني شبكة هواء خاطئة من اليوم الأول ويعرف المشكلة بعد سنوات. حل Prevost: مهندسو الشركة يصممون الشبكة مجاناً + Demo Truck يأتي لموقعك + Prevost Academy للتدريب الفني الكامل.'
      }
    ]
  },
  ownerProblems: {
    title: 'تحديات الموزع الحصري لـ Prevost بالخليج',
    problems: [
      {
        icon: 'TrendingDown',
        title: 'إغراق السوق بالوصلات المقلدة والمنافسة السعرية الشرسة',
        description: 'بائعون مجهولون يطرحون وصلات مقلدة لماركات أوروبية بربع السعر على أمازون، مما يصعّب إقناع الزبون بدفع سعر عادل للمنتج الأصلي المعتمد. المفتاح: الإبراز الدائم لتفاصيل شهادات الجودة وتكاليف الحوادث الحقيقية للوصلات الرديئة في محتوى المتجر.'
      },
      {
        icon: 'Users',
        title: 'صعوبة تثقيف السوق بالفارق بين الأصلي والمقلد',
        description: 'المشتري الصناعي الخليجي لا يزال يرى الوصلة الأوروبية "غالية مقارنة بالصيني" لأنه لا يحسب التكاليف الخفية: هدر الطاقة، تكاليف الحوادث، رسوم الإصلاح. المهمة الأولى هي تسويق "فكرة التوفير الفعلي" لا الميزة التقنية فقط.'
      },
      {
        icon: 'Truck',
        title: 'تحديات لوجستيات الشحن للمنتجات الصناعية الثقيلة',
        description: 'بكرات الخراطيم الثقيلة وأنابيب PPS الطويلة تفرض رسوم شحن FBA مرتفعة وتحتاج تغليفاً صناعياً خاصاً. الحل الأذكى: بناء علاقة مع مستودعات محلية بدبي للاحتفاظ بمخزون أنيق وشحن يومي عبر Prime Business.'
      },
      {
        icon: 'Megaphone',
        title: 'تكلفة بناء الثقة في علامة Prevost بالسوق العربي الجديد',
        description: 'Prevost معروفة في أوروبا منذ 1978 لكنها شبه مجهولة في الخليج. بناء الوعي يتطلب محتوى عربياً متخصصاً يشرح الفوارق التقنية، مقارنات واضحة، وشهادات عملاء من ورش خليجية حقيقية — لا يكفي رفع الصور على أمازون.'
      }
    ]
  },
  noMarketingProblems: {
    title: 'مخاطر غياب التسويق الرقمي لـ Prevost بالخليج',
    problems: [
      {
        icon: 'EyeOff',
        title: 'الغرق في صفحات أمازون الخلفية بدون ترتيب',
        description: 'خوارزمية A9 في أمازون تعاقب كل منتج بدون حركة مرور ومبيعات مستمرة. وصلات Prevost بدون إعلانات PPC تهبط حتماً خلف آلاف المنتجات الصينية الرخيصة ولا تراها عين أي مهندس يبحث عنها.'
      },
      {
        icon: 'TrendingDown',
        title: 'تراكم مخزون الأنابيب والخراطيم وهدر التكلفة',
        description: 'أنابيب PPS الألومنيوم وبكرات الخراطيم المكدسة في مستودعات FBA بدون بيع مستمر تفرض رسوم تخزين شهرية ثقيلة على الوكيل. الحل الإجباري: حملات PPC فعّالة + سياسة تسعير محسوبة للحفاظ على دوران المخزون.'
      },
      {
        icon: 'ShoppingCart',
        title: 'خسارة الكلمات المفتاحية لصالح المنافسين بدون إعلانات',
        description: 'المهندس الخليجي الباحث عن "Quick Coupling" أو "Air Hose Reel" أو "Compressed Air Network" سيجد منتجات منافسة لا Prevost. بدون إعلانات ومحتوى تقني محسّن، تضيع الحصة السوقية لأول من يدفع إعلانه.'
      }
    ]
  },
